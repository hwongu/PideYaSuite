 ...
 * @author hwong
 */
public class FrmPedidoCliente extends javax.swing.JInternalFrame {

    private PedidoService pedidoService = new PedidoService();
    private ProductoService productoService = new ProductoService();
    private DefaultTableModel detalleModel;
    private Usuario usuarioInicioSesion = FrmPrincipal.usuarioInicioSesion;
    ...
    public FrmPedidoCliente() {
        try {
            ...
            this.lblTituloFormulario.setText("Registrar Pedido de Producto - Cliente");
            this.setTitle("Registrar Pedido de Producto - Cliente");
            llenarCombo();
    ...
    private void llenarCombo() {
        try {
            if (usuarioInicioSesion.getTipoUsuario() == TipoUsuario.CLIENTE_NATURAL) {
                cboTipoCliente.removeAllItems();
                cboTipoCliente.addItem(TipoUsuario.CLIENTE_NATURAL.name());
            } else {
                cboTipoCliente.removeAllItems();
                cboTipoCliente.addItem(TipoUsuario.CLIENTE_EMPRESA.name());
            }
            cboCliente.removeAllItems();
            cboCliente.addItem(usuarioInicioSesion.getCliente());
            if (usuarioInicioSesion.getTipoUsuario() == TipoUsuario.CLIENTE_NATURAL) {
    ...
    private void inicializarTablaPedidosConDetalles() {
        try {
            ...
            List<Pedido> pedidos = pedidoService.listarPedidosConDetallesPorIdCliente(usuarioInicioSesion.getCliente().getIdCliente());
            ...
            Logger.getLogger(FrmPedidoCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
