 ...
 * @author hwong
 */
public class FrmCompraCliente extends javax.swing.JInternalFrame {
    ...
    public FrmCompraCliente() {
        try {
            ...
            this.lblTituloFormulario.setText("Realizar Compra de Pedidos - Cliente");
            this.setTitle("Realizar Compra de Pedidos - Cliente");
    ...
    private void inicializarTablaPedidosSinCompra() {
        ...
        try {
            // 2) Cargar datos
            List<Pedido> pedidos = pedidoService.listarPedidosSinCompraPorIdCliente(FrmPrincipal.usuarioInicioSesion.getCliente().getIdCliente());
    ...
    private void btnRealizarPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarPagoActionPerformed
        ...
        if (row >= 0) {
            try {
                ...
                Logger.getLogger(FrmCompraCliente.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
