 ...
 * @author hwong
 */
public class FrmImprimirCompra extends javax.swing.JInternalFrame {
    ...
    public FrmImprimirCompra() {
        try {
            ...
            this.lblTituloFormulario.setText("Imprimir Compras");
            this.setTitle("Imprimir Compras");
            inicializarEncabezadoJTFiltro();
        } catch (Exception ex) {
            Logger.getLogger(FrmImprimirCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void llenarDatosJTFiltro() {
        ...
        try {
            ...
            List<Compra> compras = compraService.listarComprasPorCliente(txtFiltro.getText());
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addComponent(txtFiltro, javax.swing.GroupLayout.DEFAULT_SIZE, 711, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
